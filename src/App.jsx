    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 font-sans text-slate-800 relative">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="mt-12 mb-6 text-center space-y-4">
          <p className="text-slate-400 text-sm">&copy; {new Date().getFullYear()} Smart Grade Adjuster | Created by Wahid Amiruddin | Dibuat dengan <Heart className="w-3 h-3 inline text-red-400 fill-current" /> untuk Pendidikan Indonesia.</p>
